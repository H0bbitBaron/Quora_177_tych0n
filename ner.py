...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 22:35:44 2017
...
corpus_root = "Data/gmb-2.2.0"   # Make sure you set the proper path to the unzipped corpus
...
parsed = chunker.parse(pos_tag(word_tokenize("I'm going to Germany in summer")))
