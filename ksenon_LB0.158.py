...
def main():
    ...
    df_train = pd.read_csv('/home/pavel/anaconda3/Scripts/Quora/train_features.csv', encoding="ISO-8859-1")
    ...
    df_train = pd.read_csv('/home/pavel/anaconda3/Scripts/Quora/train.csv')
    df_train = df_train.fillna(' ')

    df_test = pd.read_csv('/home/pavel/anaconda3/Scripts/Quora/test.csv')
    ...
    X_train, X_valid, y_train, y_valid = train_test_split(X_train, y_train, test_size=0.1, random_state=123) # 4242
...
# 1. Val = 0.182794; Train = 0.1421

    print('Building Test Features')
    df_test = pd.read_csv('/home/pavel/anaconda3/Scripts/Quora/test_features.csv', encoding="ISO-8859-1")
    ...
    sub.to_csv('NewBest_new_seed_v1.0.csv',index=None)
